...
local000001_xls = common.get_xls("test000001.xlsx", "Bank_Information")

#获取银行信息接口LB0112
@paramunittest.parametrized(*local000001_xls)
class testBank_Information(unittest.TestCase):
  ...
  return nowcode
    ...
    def testBank_Information(self):
        ...
        """
        # set url
        self.url = common.get_url_from_xml('Bank_Information')
