...
local000001_xls = common.get_xls("test000001.xlsx", "View_the_contract")
#H5前端查看借款合同接口LB0110

@paramunittest.parametrized(*local000001_xls)
class testView_the_contract(unittest.TestCase):
  ...
  return nowcode
    ...
    def testview_the_contract(self):
        ...
        """
        # set url
        self.url = common.get_url_from_xml('View_the_contract')
    ...
    def checkResult(self):
        ...
        if self.result == '1':
            ...
            self.assertEqual(self.info['result']["retCode"], self.retCode)
            self.assertEqual(self.info['result']["retMessage"], self.retMessage)
            print("查看借款合同失败："+ self.retMessage)
