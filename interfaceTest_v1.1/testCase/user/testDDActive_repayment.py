...
local000001_xls = common.get_xls("test000001.xlsx", "DDActive_repayment")
#订单主动还款接口LO0008

@paramunittest.parametrized(*local000001_xls)
class testDDActiverepayment(unittest.TestCase):
  ...
  return nowcode
    ...
    def testDDActive_repayment(self):
        ...
        """
        # set url
        self.url = common.get_url_from_xml('DDActive_repayment')
