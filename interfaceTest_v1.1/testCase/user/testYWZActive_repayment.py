...
local000001_xls = common.get_xls("test000001.xlsx", "YWZActive_repayment")
#业务帐APP划扣接口CBA0064

@paramunittest.parametrized(*local000001_xls)
class testYWZActive_repayment(unittest.TestCase):
    ...
    def setParameters(self, case_name, method,cookie ,appKey,apiCode,bizCode, data, result, code, msg,retCode,retMessage):
        ...
        #额度订单应用密钥appSecret = '7ae1d8aab34a4a0881fe3446438fa62f'，根据appsecret 判断接口调用方向,谁发起调用使用谁的
        #appsecret
        self.appSecret = '7ae1d8aab34a4a0881fe3446438fa62f'
        '''
        sign 开发源码生成规则
  ...
  return nowcode
    ...
    def testYWZActive_repayment(self):
        ...
        """
        # set url
        self.url = common.get_url_from_xml('YWZActive_repayment')
