...
local000001_xls = common.get_xls("test000001.xlsx", "Four_Elements_Certification")
#四要素及绑卡认证接口LB0086

@paramunittest.parametrized(*local000001_xls)
class testFour_Elements_Certification(unittest.TestCase):
  ...
  return nowcode
    ...
    def testFour_Elements_Certification(self):
        ...
        """
        # set url
        self.url = common.get_url_from_xml('Four_Elements_Certification')
