...
local000001_xls = common.get_xls("test000001.xlsx", "Generating_orders")
#前端H5发起借款申请接口LB0084，订单系统生成订单

@paramunittest.parametrized(*local000001_xls)
class testGenerating_orders(unittest.TestCase):
  ...
  return nowcode
    ...
    def testGenerating_orders(self):
        ...
        """
        # set url
        self.url = common.get_url_from_xml('Generating_orders')
