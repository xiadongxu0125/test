...
local000001_xls = common.get_xls("test000001.xlsx", "Quota_query")


@paramunittest.parametrized(*local000001_xls)
class testQuota_query(unittest.TestCase):


    def setParameters(self, case_name, method,cookie ,appKey,apiCode,bizCode, mobileNo, result, code, msg,retCode,retMessage):
        """
        set params
        :param case_name:
        :param method:
  ...
  return nowcode
    ...
    def testQuota_query(self):
        ...
        """
        # set url
        self.url = common.get_url_from_xml('Quota_query')
