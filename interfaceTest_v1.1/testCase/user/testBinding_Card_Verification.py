...
local000001_xls = common.get_xls("test000001.xlsx", "Binding_Card_Verification")

#绑卡验证接口LB0104
@paramunittest.parametrized(*local000001_xls)
class testBinding_Card_Verification(unittest.TestCase):
  ...
  return nowcode
    ...
    def testLoan_Verification(self):
        ...
        """
        # set url
        self.url = common.get_url_from_xml('Binding_Card_Verification')
